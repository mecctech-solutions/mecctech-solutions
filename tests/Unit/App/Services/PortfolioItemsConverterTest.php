...
class PortfolioItemsConverterTest extends TestCase
{
    ...
    public function it_should_convert_excel_file_to_portfolio_items()
    {
        ...
        $portfolioItems = array(
            array("Title", "Titel", "Main Image URL", "Description", "Beschrijving", "Website URL", "Image 1 URL", "Image 2 URL", "Image 3 URL", "Image 4 URL", "Image 5 URL", "Image 6 URL", "Image 7 URL", "Tag 1", "Tag 2", "Tag 3", "Tag 4", "Bullet 1 NL", "Bullet 1 EN", "Bullet 2 NL", "Bullet 2 EN", "Bullet 3 NL", "Bullet 3 EN"),
            array("Test Title 1", "Test Titel 1", "main-image-url-1", 'Description 1', "Beschrijving 1", 'website-url-1', "image-1-url", "image-2-url", "image-3-url", "image-4-url", "image-5-url", "image-6-url", "image-7-url", "Tag 1", "Tag 2", "Tag 3", "Tag 4", "Bullet 1 NL", "Bullet 1 EN", "Bullet 2 NL", "Bullet 2 EN", "Bullet 3 NL", "Bullet 3 EN")
        );
        ...
        self::assertEquals(3, sizeof($portfolioItems->first()->bullet_points));
        ...
        self::assertEquals(4, sizeof($portfolioItems->first()->tags));
        ...
        self::assertEquals(7, sizeof($portfolioItems->first()->images));
