...
class PortfolioItemsConverterTest extends TestCase
{
    ...
    public function it_should_convert_excel_file_to_portfolio_items()
    {
        ...
        $portfolioItems = array(
            array("Title", "Main Image URL", "Description", "Website URL", "Image 1 URL", "Image 2 URL", "Image 3 URL", "Image 4 URL", "Tag 1", "Tag 2", "Tag 3"),
            array("Test Title 1", "main-image-url-1", 'Description 1', 'website-url-1', "image-1-url", "image-2-url", "image-3-url", "image-4-url", "Tag 1", "Tag 2", "Tag 3")
        );
