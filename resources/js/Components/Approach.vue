            ...
            <div class="ud-pt-[120px] ud-pb-[90px] ud-border-t ud-border-[#E9ECF8]">
                <div class="ud-flex ud-flex-wrap ud-mx-[-16px]">
                    <div class="ud-w-full ud-px-4">
                        <div
                            class="ud-max-w-[600px] ud-mx-auto ud-text-center ud-mb-[70px]"
                        >
                <span
                    class="
                ...
                "
                  ...
                  "
                            >
                                {{ trans('approach.requirements_text') }}
                            </p>
                            <div>
                ...
                "
                  ...
                  "
                            >
                                {{ trans('approach.development_text') }}
                            </p>
                            <div>
                  <span class="ud-absolute ud-top-0 ud-right-0 ud--z-1">
                    <svg
                ...
                "
                  ...
                  "
                            >
                                {{ trans('approach.user_interface_text') }}
                            </p>
                            <div>
                  <span class="ud-absolute ud-top-0 ud-right-0 ud--z-1">
                    <svg
