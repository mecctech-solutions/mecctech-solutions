    ...
    <div class="flex flex-col items-left">
        <div class="flex items-center w-1/2">
            <a href="https://planttipsenstyling.nl">
                <img class="p-10 w-140 hover:scale-105 transform ease-in-out duration-500 cursor-pointer" src="images/cropped-plant-tips-en-styling-nl-logo.png" alt="Plant tips en styling logo">
            </a>
