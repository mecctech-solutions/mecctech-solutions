        ...
        <div class="flex flex-col items-center">
            ...
            <div class="m-10 flex flex-col md:flex-row justify-center items-center md:space-x-20">
                ...
                <div class="flex flex-col items-center md:w-1/4">
                    ...
                    <p class="text-2xl text-center md:text-left">I'm a full-stack web developer and freelancer specialized in writing e-commerce software in Laravel / PHP and Vue.js. Count on me to write extensible and maintainable full web applications for your e-commerce business, thus increasing your revenue.</p>
                </div>
            </div>
        </div>
    </section>
