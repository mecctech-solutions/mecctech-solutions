...
return [
    ...
    "design" => "Ontwerp",
    "design_summary" => "Voordat ik ga programmeren maak ik een ontwerp van de code",
    "functionality" => "Functionaliteit",
    "functionality_summary" => "Schaalbare, leesbare en onderhoudbare logica",
    "user_interface" => "User Interface",
    "user_interface_summary" => "Mooie, dynamische en responsieve UI",
];
